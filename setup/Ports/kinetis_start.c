...
void LLWU_IRQHandler()        __attribute__ ((weak, alias("Fault_Handler")));
...
void LPTimer_IRQHandler()     __attribute__ ((weak, alias("Fault_Handler")));
void PORTA_IRQHandler()       __attribute__ ((weak, alias("Fault_Handler")));
