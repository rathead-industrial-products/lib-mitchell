...
void test_d_basic_formatting(void) {
    ...
    TEST_ASSERT_EQUAL_INT(5, snprintf (buf, 128, "%5.0d",    0)); TEST_ASSERT_EQUAL_STRING("     ", buf); resetTest();
...
void test_u_basic_formatting(void) {
    ...
    TEST_ASSERT_EQUAL_INT(5, snprintf (buf, 128, "%5.0u", 0)); TEST_ASSERT_EQUAL_STRING("     ", buf); resetTest();
...
void test_x_basic_formatting(void) {
    ...
    TEST_ASSERT_EQUAL_INT(5, snprintf (buf, 128, "%5.0x", 0)); TEST_ASSERT_EQUAL_STRING("     ", buf); resetTest();
...
#if (0) // not supported in this branch of printf-emb_tiny
void test_e_basic_formatting(void) {
    ...
    TEST_ASSERT_EQUAL_INT(5,  snprintf (buf, 128, "%.0e",         0)); TEST_ASSERT_EQUAL_STRING("0e+00",          buf); resetTest();
...
void test_compound_specifiers(void) {
    TEST_ASSERT_EQUAL_INT(13, snprintf (buf, 128, "%s = %d", "Answer 5", 27)); TEST_ASSERT_EQUAL_STRING("Answer 5 = 27", buf); resetTest();
    TEST_ASSERT_EQUAL_INT(23, snprintf (buf, 128, "%s %s %s", "string1", "string2", "string3")); TEST_ASSERT_EQUAL_STRING("string1 string2 string3", buf); resetTest();
    TEST_ASSERT_EQUAL_INT(38, snprintf (buf, 128, "val1 = %d, val2 = %#x, val3 = %s", 15, 31, "string1")); TEST_ASSERT_EQUAL_STRING("val1 = 15, val2 = 0x1f, val3 = string1", buf); resetTest();
}
